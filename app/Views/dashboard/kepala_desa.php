...
<div class="dashboard-wrapper">
    <div class="sidebar">
        ...
        <p style="font-size: 0.75rem; text-transform: uppercase; letter-spacing: 1px; color: #cbd5e1; font-weight: 600; margin-bottom: 1rem; padding-left: 0.5rem;">Menu Kepala Desa</p>
