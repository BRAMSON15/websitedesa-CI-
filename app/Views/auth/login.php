...
<div class="hero" style="padding-top: 0;">
    ...
    <div class="container" style="display: flex; height: 100vh; align-items: center; justify-content: center; z-index: 10; position: relative;">
        ...
        <div class="glass" style="width: 100%; max-width: 450px; padding: 2.5rem; position: relative; z-index: 2;">
            <div style="text-align: center; margin-bottom: 2rem;">
                ...
                <h2 style="font-size: 1.8rem; margin-bottom: 0.5rem; color: var(--dark);">Sistem Informasi Desa</h2>
                <p style="color: #64748b; font-size: 0.95rem;">Silakan masuk untuk melanjutkan akses</p>
            </div>
