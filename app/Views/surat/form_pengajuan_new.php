...
<body>
    <div class="container">
        ...
        <form action="<?= base_url('/surat/submit') ?>" method="POST">
            ...
            <div class="form-card">
                ...
                <?php $jenisSurat = $jenis_surat['nama_surat']; ?>
            ...
            <!-- Pernyataan -->
            <div class="form-card" style="background: linear-gradient(135deg, #fef3c7, #fde68a); border-left: 4px solid #f59e0b;">
                <h4 style="color: #92400e; margin-bottom: 1rem;">
                    <i class="ri-shield-check-line" style="color: #f59e0b;"></i> Pernyataan
                </h4>
                <div class="checkbox-group">
                    <input type="checkbox" id="pernyataan" required>
                    <label for="pernyataan" style="color: #78350f; line-height: 1.6; cursor: pointer;">
    ...
    <script>
        ...
        console.log('Total inputs:', document.querySelectorAll('input, textarea, select').length);
        
        // Test input functionality
        setTimeout(() => {
            const testInput = document.getElementById('keperluan');
            if (testInput) {
                testInput.focus();
